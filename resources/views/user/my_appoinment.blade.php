      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            @auth  
            <li class="nav-item">
              <a class="nav-link" style="background-color: greenyellow" href="{{url('myappoinment')}}">My Appoinment</a>
            </li>
            <x-app-layout>
          </x-app-layout>                           
    ...
    <table align="center" padding="70px">
       <tr style="background-color: black">
        ...
        <tr style="background-color: black">
            ...
            <td><a onclick="return confirm('Are you sure to delete;')" href="{{url('cancel_appoint',$appoints->id)}}"   class="btn btn-danger">cancel</a></td>
        </tr>
        @endforeach
    </table>
   </div>
